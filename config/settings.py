...
class Settings(BaseSettings):
    ...
    # --- CORS ---
    cors_origins: str = "http://localhost:3000,http://localhost:3001,http://localhost:3002,https://adaptive-trading-ecosystem.vercel.app,https://frontend-phi-liart-27.vercel.app"  # Comma-separated allowed origins
