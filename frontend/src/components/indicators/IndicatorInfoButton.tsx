        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className={`inline-flex items-center justify-center rounded-full ${btnSize} text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50`}
